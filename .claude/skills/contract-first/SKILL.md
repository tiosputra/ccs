---
name: contract-first
description: Use when a change is visible across a boundary - a new or changed endpoint, a new or renamed response field, a socket event, a payload, or an error shape - and consumers must build against it without field drift or integration surprises. Also use when writing or revising a task's api-contract.md.
metadata:
  origin: ECC
---
